...
# FIX: Swapped reversed hint messages — "Too High" now correctly says Go LOWER, "Too Low" says Go HIGHER
...
# FIX: Moved score logic from app.py; win points decrease with attempts, floored at 10
